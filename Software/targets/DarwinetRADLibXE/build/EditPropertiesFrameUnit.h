...
class PACKAGE TEditApplicationPropertiesFrame : public TFrame, public c_ApplicationPropertiesModelListenerIfc
{
...
private:	// User declarations
	...
	/**
	  ...
	  */
	boost::shared_ptr<c_ApplicationPropertiesModel> m_pTestBenchPropertiesModel;
//	c_ApplicationPropertiesModel* m_pTestBenchPropertiesModel;
...
public:		// User declarations
	...
	/**
	  ...
	  */
//	c_ApplicationPropertiesModel* getTestBenchPropertiesModel();
	boost::shared_ptr<c_ApplicationPropertiesModel> getTestBenchPropertiesModel();
