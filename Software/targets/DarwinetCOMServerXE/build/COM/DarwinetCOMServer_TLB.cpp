...
// $Rev: 46046 $
// File generated on 2013-05-15 14:10:52 from Type Library described below.
...
const GUID IID_IDarwinetMIVs = {0xD5019007, 0xC26E, 0x42BE,{ 0x96, 0x01, 0x50,0x0C, 0xEF, 0xD1,0xC8, 0x29} };
const GUID DIID_IDarwinetMIVsEvents = {0x232B48D1, 0x1251, 0x4155,{ 0xAF, 0x05, 0x33,0xF6, 0x10, 0x12,0x95, 0x9E} };
const GUID CLSID_DarwinetMIVs = {0xF1935855, 0x391D, 0x4C4C,{ 0x8E, 0x2A, 0x64,0x75, 0x86, 0xF9,0xDF, 0x8C} };
