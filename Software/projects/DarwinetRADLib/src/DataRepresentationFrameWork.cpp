...
//	#define COMPILE_UNALLOWED_CONSTRUCTS // Try to compile constructs that must generate compile errors
	...
	{
		c_DataRepresentationFramework::c_ISO_8859_1_String source1("This is an ISO 8859 string with ���");
		c_DataRepresentationFramework::c_ISO_8859_1_String source2("This is an ISO 8859 string with ���");
	...
	{
		c_DataRepresentationFramework::c_CppLiteralString source("This is a C++ literal string with �");
	...
	{
		c_DataRepresentationFramework::c_ISO_8859_1_String source("This is an ISO-8859-1 string with �");
	...
	{
		c_DataRepresentationFramework::c_CppLiteralString source("This is an c++ literal string with ���");
...
//	return result;
	...
	result = _UTF8sz(sUTF8String.c_str());
        ...
        /** 
         * Quick fix. Simply narrow the UTF16 string down into the an UTF8 string.
         * This should work for ASCII 0..127 (and possible also 128..255?)
         */
        #warning UTF16 mapped UTF8 without coding. Please implement proper transform for this environment! 
	 ...
	 * If your compiler does not recognize the code it may be that you have not Install it to your build environment or missed to add it to include paths.
...
//		  result += '>';
		  ...
		  // If not, then for '�' the format call below returns "<0�>"...
