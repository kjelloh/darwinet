...
/**
  * Models a collection of properties
  */
class c_ApplicationPropertiesModel {
public:
...
/**
  ...
  * is needed.
  */
class c_ApplicationPropertiesModelChangeDetector : public c_ApplicationPropertiesModelListenerIfc {
public:
	/**
