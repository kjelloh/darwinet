...
#if ((BOOST_VERSION / 100 % 1000) > 39)
	// Use officila boost functionality insetad of hidden utf8_codecvt_facet
	// http://www.boost.org/doc/libs/1_49_0/libs/locale/doc/html/main.html
...
/**
  * A general c_DataRepresentationFramework::doTests Excpetion
  */
class DRFWException : public std::runtime_error {
public:

	DRFWException(const std::string& s) : std::runtime_error(s) {}
...
/**
  ...
  */
c_DataRepresentationFramework::c_UTF8String& c_DataRepresentationFramework::toUTF8String(const c_DataRepresentationFramework::c_UTF8String& sUT8String) {
	return const_cast<c_DataRepresentationFramework::c_UTF8String&>(sUT8String);
}
...
#if ((BOOST_VERSION / 100 % 1000) > 39)
		// http://www.boost.org/doc/libs/master/libs/locale/doc/html/charset_handling.html
		// 141202, boost::locale::conv utf routines seems to asume utf-encoding based on
		//         provided char type. I suppose UTF-16 is recognized by char type beeing t_char16?
		result.anonymous() = boost::locale::conv::utf_to_utf<c_DataRepresentationFramework::c_UTF16String::CharType>(sUTF8String);
#else
	#error
#endif
...
c_DataRepresentationFramework::c_UTF8String c_DataRepresentationFramework::toUTF8String(const c_DataRepresentationFramework::c_UCF4String& sUCF4String) {
	...
	try {
#if ((BOOST_VERSION / 100 % 1000) > 39)
		result.anonymous() = boost::locale::conv::utf_to_utf<char>(sUCF4String);
#else
		...
		result.anonymous() = "...UTF-8 encoding failed!";
	}
/*
...
c_DataRepresentationFramework::c_UCF4String c_DataRepresentationFramework::toUCF4String(const c_UTF8String& sUTF8String) {
	...
	try {
#if ((BOOST_VERSION / 100 % 1000) > 39)
		result.anonymous() = boost::locale::conv::utf_to_utf<wchar_t>(sUTF8String);
#else
		...
		result = c_DataRepresentationFramework::c_UCF4String(L"...UCF4 encoding failed!");
	}
	return result;
}
...
/**
  ...
  * Will throw an data representation framework excpetion DRFWException in case
  * of failure.
  */
